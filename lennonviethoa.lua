-- ==============================================================================
--  LENNON HUB KAITUN - ZERO-LAG TRANSLATION ENGINE V1.0 (LUARMOR SAFE)
--  Tối ưu hóa:
--    1. Nạp đúng luồng script gốc Lennon Hub (Luarmor Loader).
--    2. Luarmor Bypass: Thêm bộ đệm (Debounce) chống Crash do vòng lặp Text động.
--    3. Từ điển 4 ngôn ngữ (Anh, Việt, Philippines, Indonesia) chuyên biệt cho Lennon Hub.
--    4. Nút bấm Frosted Slate Top-Center tinh tế, sang trọng.
-- ==============================================================================
...
-- ==================== 2. TỪ ĐIỂN 3 NGÔN NGỮ (LENNON HUB) ====================
...
-- ==================== 3. NÚT ĐỔI NGÔN NGỮ (TOP-CENTER Y=15) ====================
...
-- ==================== 4. BỘ QUÉT DEFER (CHỐNG PHÁT HIỆN BỞI LUARMOR) ====================
