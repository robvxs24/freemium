-- ==============================================================================
--  RONNEI HUB - STEAL AN EGG (OFFICIAL V1.3 - OVERLAY LAYER MODE)
--  Chiến lược: Đè menu và logo Ronnei Hub lên trên cùng | Giữ nguyên Anti Hit ngầm
...
-- ==================== 2. KHỞI TẠO SCREEN GUI (ĐẶT LỚP CAO NHẤT ĐỂ ĐÈ LÊN TRÊN) ====================
...
ScreenGui.DisplayOrder = 2147483647 -- Đỉnh cao nhất của màn hình, đè mọi thứ
ScreenGui.Parent = parentTarget

-- ==================== 3. TÌM NGẦM NÚT ANTI HIT ĐỂ ĐỒNG BỘ TRẠNG THÁI ====================
...
local function hookOriginalUI(inst)
    pcall(function()
        ...
        if inst:IsA("TextLabel") or inst:IsA("TextButton") then
            ...
            if txt:find("ANTI HIT") and not txt:find("RONNEI") then
