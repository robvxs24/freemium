...
-- ==================== 5. FE INVISIBILITY (-12 STUDS & 226°) ====================
task.spawn(function()
...
NoteCard.Name = "Modal_" .. HttpService:GenerateGUID(false):sub(1, 6)
...
ToggleBtn.Name = "Float_" .. HttpService:GenerateGUID(false):sub(1, 6)
